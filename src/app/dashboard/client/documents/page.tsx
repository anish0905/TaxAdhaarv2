...
export default function MyDocumentsPage() {
  // Mock Data: Isse baad mein database se replace karein
  const documents = [
      ...
      <div className="bg-white rounded-[2.5rem] border border-slate-100 shadow-xl overflow-hidden">
                ...
                <tr key={doc.id} className="group hover:bg-blue-50/30 transition-all">
                  <td className="px-8 py-6">
                    <div className="flex items-center gap-4">
                      ...
                      <div>
                        <p className="text-sm font-black text-slate-900 truncate max-w-[150px] md:max-w-xs">{doc.name}</p>
        ...
        {documents.length === 0 && (
          <div className="py-20 flex flex-col items-center opacity-20">
            <UploadCloud size={64} />
            <p className="mt-4 font-black uppercase tracking-widest text-sm">No documents found</p>
          </div>
        )}
      </div>
    </div>
