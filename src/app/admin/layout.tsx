...
export default function AdminLayout({ children }: { children: React.ReactNode }) {
  ...
  const navLinks = [
    ...
    {name:"Blogs", href:"/admin/blogs", icon:<History size={18} />},
    {name:"Toolkit Products", href:"/admin/toolkit", icon:<History size={18} />},
    {name:"Assets", href:"/admin/assets", icon:<History size={18} />},
